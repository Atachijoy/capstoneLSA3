                            ...
                            <b-col class="col-12">
                                <b-form-group>
                                    ...
                                    <b-input-group>
                                        ...
                                        <b-form-select placeholder="Prioridad" v-model="prioridadFiltro"
                                            id="prioridad-filtro" :options="prioridadOpciones" />
                                        ...
                                        <b-button-group style="margin-left:10px; margin-right:20px">
                                            <b-button class="reactive-button lsa-blue"
                                                @click="filtrarTabla">Filtrar</b-button>
                                            <b-button class="reactive-button lsa-orange"
                                                @click="borrarFiltro">Quitar</b-button>
                                        </b-button-group>
                                    </b-input-group>
                ...
                <b-table show-empty :busy="loading" :items="muestrasFiltradas" :fields="fields" :per-page="perPage"
                    ...
                    <template #cell(accion)="row">
                        ...
                        <b-dropdown right size="sm" variant="link" toggle-class="text-decoration-none" no-caret>
                            ...
                            <b-dropdown-item @click="abrirIngresoResultado(row.item)">
                                <b-icon icon="check2-square" aria-hidden="true" class="mr-2"></b-icon>Observar resultados
                            </b-dropdown-item>
                        </b-dropdown>
                    </template>
                    ...
                    <template #custom-foot>
                        <b-tr>
                            <b-th colspan="9"
                                style="background-color:rgb(235, 235, 235); border-radius:0px 0px 20px 20px; padding:1px"
                                v-if="filtrando">
                                <div>
...
<script>
import ModalObservaciones from '@/components/admMuestras-supervisor/modal_observacionesMuestra-supervisor.vue';
...
export default {
    ...
    methods: {
        ...
        obtenerMuestras() {
            ...
            MuestraSupervisorService.obtenerMuestras().then((response) => {
        ...
        MostrarObservaciones(data) {
            ...
            this.$bvModal.show('modal-observaciones-muestra-supervisor');
        },
        abrirAnalistasDesignados(data) {
            console.log(data)
        ...
        abrirDetallesMuestra(data) {
            ...
            this.$bvModal.show('modal-detalle-muestra-supervisor');
        },
        abrirCompletarAnalisis(data) {
            console.log(data)
            this.muestraData = data;
        ...
        abrirIngresoResultado(data){
            this.$router.push({name: '/ingreso-resultados', params: {RUM: data.RUM}});
        },
