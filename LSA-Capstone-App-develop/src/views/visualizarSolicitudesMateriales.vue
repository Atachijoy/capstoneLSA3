<template>
    <div class="home">
        ...
        <div>
            ...
            <b-navbar toggleable="lg" type="light" variant="faded">
                ...
                <b-collapse id="nav-collapse" is-nav class="navbar-text">
                    <b-navbar-nav>
                        ...
                        <b-nav-item href="#" class="navbar-item" to="/visualizarSolicitudesMateriales"> Solicitudes de
                            materiales y reactivos</b-nav-item>
                        <b-nav-item href="#" class="navbar-item" to="/visualizarSolicitudesCompra"> Solicitudes de compras
                        </b-nav-item>
            ...
            <h1 style="padding-bottom: 3%;">Solicitudes de materiales o reactivos</h1>
...
export default {
    ...
    {
        obtenerSolicitudes() {
            axios.get('https://lsa.laboratorioquimico.cl/public/api/solicitudes/obtenerSolicitudMaterial').then((response) => {                
